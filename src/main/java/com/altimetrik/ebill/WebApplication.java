...
import com.altimetrik.ebill.filter.ApiOriginFilter;
...
@EntityScan("com.altimetrik.ebill.models")
@EnableJpaRepositories("com.altimetrik.ebill.models.repository")
